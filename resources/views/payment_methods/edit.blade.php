            ...
            <x-ui.card>
                ...
                <form method="POST" action="{{ route('payment_methods.update', $paymentMethod) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-ui.input type="text" name="name" value="{{ old('name', $paymentMethod->name) }}" required maxlength="100" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-ui.textarea name="description" rows="3" maxlength="500">{{ old('description', $paymentMethod->description) }}</x-ui.textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <x-ui.input type="number" name="default_price" value="{{ old('default_price', (int)$paymentMethod->default_price) }}" min="0" step="1000" />
