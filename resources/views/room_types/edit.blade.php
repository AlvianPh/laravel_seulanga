            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('room_types.update', $roomType) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name', $roomType->name) }}" required maxlength="100"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="3" maxlength="500"
                                  class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $roomType->description) }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="default_price" value="{{ old('default_price', (int)$roomType->default_price) }}" min="0" step="1000"
                               class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
