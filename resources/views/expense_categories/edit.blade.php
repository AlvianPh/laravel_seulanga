<x-app-layout>
    ...
    <div class="max-w-xl mx-auto space-y-6">
        <x-ui.card>
            <div class="mb-6">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">Edit Kategori Pengeluaran</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Ubah nama atau rincian deskripsi kategori</p>
            </div>
            ...
            <form method="POST" action="{{ route('expense_categories.update', $expense_category) }}">
                ...
                <div class="mb-4">
                    ...
                    <x-ui.input type="text" name="name" value="{{ old('name', $expense_category->name) }}" required maxlength="100" class="text-sm" />
                ...
                <div class="mb-6">
                    ...
                    <x-ui.textarea name="description" rows="3" maxlength="255" class="text-sm">{{ old('description', $expense_category->description) }}</x-ui.textarea>
