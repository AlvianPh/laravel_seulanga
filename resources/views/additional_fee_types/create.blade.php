                ...
                <div class="p-6">
                    <form action="{{ route('additional_fee_types.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ old('nama') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" min="0" name="nilai_default" id="nilai_default" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ old('nilai_default', '0') }}" required>
