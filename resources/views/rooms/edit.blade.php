                            ...
                            <div class="mb-4">
                                ...
                                <select name="type" required class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    @foreach ($types as $type)
                                        <option value="{{ $type->value }}" {{ old('type', $room->type->value) === $type->value ? 'selected' : '' }}>
                                            {{ $type->label() }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mt-8 border-t pt-6">
                        ...
                        <div class="mb-6 grid grid-cols-2 md:grid-cols-4 gap-3">
                            @php
                                ...
                                $roomFacilities = is_array($room->facilities) ? $room->facilities : [];
                                $oldFacilities = old('facilities', $roomFacilities);
                            @endphp
