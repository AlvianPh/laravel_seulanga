            ...
            <form method="POST" action="{{ route('rooms.update', $room) }}" enctype="multipart/form-data">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700/70">
                    ...
                    <div x-data="{
                        ...
                        <label class="block text-xs font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300 mb-1.5">Tambah Foto Kamar Baru (Max 5 total, @2MB)</label>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                                <template x-for="(url, idx) in previewUrls" :key="idx">
                                    <div class="relative group rounded-xl overflow-hidden border-2 border-indigo-500/80 shadow-xs">
                                        ...
                                        <div class="absolute bottom-1 left-1 bg-gray-900/80 text-white text-[9px] font-bold px-1.5 py-0.5 rounded" x-text="'#' + (idx + 1)"></div>
                                    </div>
                                </template>
                            </div>
                        </div>
